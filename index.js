...
The reason we are writing this press release is ${input.prType}. 

Here is an overview of details I have got to manage, rest you need to manage this professionally: ${input.details}. 

This is the ${input.tone} tone you need to use throughout this press release. 

The company for which we are writing this press release is ${input.companyName}. 

Here is a brief description of the company, including the value proposition and key details: ${input.companyDesc}. 

Here is what the C-level executive of that company has to say: ${input.adQuotes}. 
